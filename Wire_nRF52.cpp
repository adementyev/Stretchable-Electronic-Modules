...
void TwoWire::begin(void) {
  //Master Mode
  //Artem: Changed this code, the driver was hanging up during clock stretching. 
  ...
  _p_twim->FREQUENCY = TWIM_FREQUENCY_FREQUENCY_K400 << TWIM_FREQUENCY_FREQUENCY_Pos;
  _p_twim->SHORTS = 0;
...
uint8_t TwoWire::requestFrom(uint8_t address, size_t quantity, bool stopBit)
{
  ...
  //_p_twim->EVENTS_STOPPED = 0; //added 
  _p_twim->TASKS_STARTRX = 0x1UL;

  //while (_p_twim->EVENTS_STOPPED == 0); //added 
